...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO creare 2 metodi "main" separati, uno per il cliente e uno per l'amministratore
        // Creare ed implementare la logica che, a seconda dell'utente che accede, mostra un menu differente, con funzionalità differenti

        while (true) {
            view.showMainMenuUser();

            int choice = Utility.askInt();
            switch(choice) {
                case 1 -> oController.ordinaPizza();
                case 2 -> oController.tracciaOrdine();
                // TODO creare metodo modificaOrdine(), per il cliente, in OrderController
                // Al momento è possibile modificare solo lo stato, ma, quella feature, non è per il cliente
                // case 3 -> modificaOrdine();
                case 4 -> oController.eliminaOrdine();
                // case 5 -> menuAdmin();
